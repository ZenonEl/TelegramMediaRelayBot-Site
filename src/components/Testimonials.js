...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: "Не ограниченная группировка контактов по категориям Семья, Друзья, Work - это находка! Теперь смешные видео идут друзьям и семье, а полезные туториалы коллегам.",
      platform: "github",
      verified: true,
      date: "2025-02-10",
    },
