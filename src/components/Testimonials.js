  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Устал постоянно скачивать видео с YouTube и пересылать коллегам вручную. С этим ботом просто кидаю ему ссылку с нужным мне описанием, и он сам всё скачивает и отправляет коллегам. Экономлю кучу времени каждый день!",
      platform: "vk",
      verified: true,
      date: "2025-01-15",
    },
    ...
    },
    {
      ...
      rating: 4,
      text: "Наконец-то решение для семейного чата! Младшие братья постоянно просили скачать им что-то с YouTube или отправить мемы из Reddit. Теперь бот всё делает автоматически.",
      platform: "telegram",
      verified: true,
      date: "2025-01-25",
    },
    ...
    },
    {
      ...
      rating: 5,
      text: "Не ограниченная группировка контактов по категориям Семья, Друзья, Work - это находка! Теперь смешные видео идут друзьям и семье, а полезные туториалы коллегам. Бот понимает контекст по хештегам и никого не спамит лишним контентом.",
      platform: "github",
      verified: true,
      date: "2025-02-10",
    },
